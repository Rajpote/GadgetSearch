<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $address = $_POST['address'];
            ...
            if ($stmt->execute()) {
                echo '<script> alert("User data updated successfully."); window.location.href = "userdata.php"; </script>';
            } else {
                echo '<script> alert("An error occurred while updating the user."); </script>';
            }
        }
?>
  ...
  <div class="container1">
   <form action="" method="POST" class="register-form">
    ...
    <div class="container">
     ...
     <textarea name="address" id="" cols="30" rows="2" name="address"><?php  echo $result['address'];?></textarea>
    </div>
